 ...
 * @property float|null $phone_number
 ...
 * @method static \Illuminate\Database\Eloquent\Builder<static>|User whereSecondaryName($value)
...
class User extends Authenticatable
{
    ...
    {
        return $this->accountType->permissions();
    }

    public function hasPermission($permissionName)
    {
        return $this->accountType->permissions->contains('name', $permissionName);
    }
}
